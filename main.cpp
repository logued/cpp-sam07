// Pointers_Char_Arrays.cpp :	Feb 2022
...
Note that there is a string class in C++ that makes dealing with strings easier,
...
int main()
{
    ...
    // The null escape character '\0' is added to the end of the string (i.e, as the sixth character)
    ...
    {
        cout << *p;
        p++;			// a char is 1-byte long, so pointer increments by one element
    }
    cout << endl << endl;
